"""PA 문장 분할기 - 번def split_target_sentences_advanced(text: str, max_length: int = 150, splitter: str = "punctuation") -> List[str]:
    """
    ...
    return merged if merged else [text]미적 병합만 지원"""
