...
```xml
<동양고전 식별자="" id="" name="" lang="chi" year="2017">
  <ViewdocList>
    <BaseID>ID:jti_4c0221</BaseID>
    <편>
      <Viewdoc>
        <장 식별자="ID:C4" 편명="歐陽文忠公文抄引">
          <제목 level="1" type="" pid="ID:jti_4c0221" 식별자="ID:C4">歐陽文忠公文抄引</제목>
          <내용 id="1874">
            <!-- 원문 콘텐츠 -->
            <원문 식별자="ID:W1" SEQ="1" lang="chi">
              <단락 id="1">
                <s id="1">
                  <c id="1"><w id="1">歐陽文忠公文抄引</w></c>
                </s>
              </단락>
              <단락 id="2">
                <s id="2">
                  <c id="2"><w id="2">西京以來로</w> <w id="3">獨稱太史公遷은</w>...</c>
                  <c id="3"><w id="9">譬之覽仙姬於瀟湘洞庭之上에</w> <w id="10">可望而不可近者라</w></c>
                </s>
              </단락>
            </원문>
            ...
            <!-- 예시를 위해 구조만 차용 -->
            <번역문 식별자="ID:W1_T" SEQ="2" lang="kor">
              <단락 id="1">
                <s id="1">
                  <c id="1"><w id="1">≪구양문충공문초(歐陽文忠公文抄)≫의 서문</w></c>
                </s>
              </단락>
              <단락 id="2">
                <s id="2">
                  <c id="2"><w id="2">서한(西漢) 이래로</w> <w id="3">태사공(太史公) 사마천(司馬遷)만을 유독 일컫는 것은</w>...</c>
                  <c id="3"><w id="9">비유하자면 소상(瀟湘), 동정호(洞庭湖) 가에서 선희(仙姬)를 만났을 때</w> <w id="10">멀리서 볼 수는 있고 가까이 다가갈 수 없는 것과 [-같다.]</w></c>
                </s>
              </단락>
            </번역문>
          </내용>
...
| 문장식별자 | 구식별자 | 원문 | 번역문 |
|:---:|:---:|:---|:---|
| 1 | 1 | 歐陽文忠公文抄引 | ≪구양문충공문초(歐陽文忠公文抄)≫의 서문 |
| 2 | 2 | 西京以來로 | 서한(西漢) 이래로 |
| 2 | 3 | 獨稱太史公遷은 | 태사공(太史公) 사마천(司馬遷)만을 유독 일컫는 것은 |
| 2 | 4 | 以其馳驟跌宕하고 | 그 문장(文章)이 거침없이 치닫고 |
| 2 | 5 | 悲慨嗚咽하여 | 비분해 오열하듯 하여 |
| ... | ... | ... | ... |
...
|:---:|:---:|:---|:---|
| 1 | 1 | 歐陽文忠公文抄引 | ≪구양문충공문초(歐陽文忠公文抄)≫의 서문 |
| 1 | 2 | 西京以來로 獨稱太史公遷은... | 서한(西漢) 이래로 태사공(太史公) 사마천(司馬遷)만을... |
| 1 | 3 | 累數百年而得韓昌黎나 然彼固別開門戶也요 | 수백 년이 지나서 한창려(韓昌黎)(한유(韓愈))가 나타났으나... |

**문단병렬 (문단 단위)**

| 문단식별자 | 원문 | 번역문 |
|:---:|:---|:---|
| 1 | 歐陽文忠公文抄引 西京以來로 獨稱太史公遷은... | ≪구양문충공문초(歐陽文忠公文抄)≫의 서문 서한(西漢) 이래로... |
| 2 | 予讀唐書五代史別有鈔하고 今錄其文集行世者하되... | 내가 ≪당서(唐書)≫‧《오대사(五代史)》를 읽고 따로 초본(鈔本)을... |
