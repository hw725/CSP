...
try:
    ...
    raise ImportError("FlagEmbedding package not found. BGE embedder will not be available.")
    ...
    if _bge_model is None:
        ...
        try:
            ...
            try:
                ...
                logger.info("Local model not found, downloading BGE-M3 model...")
                _bge_model = FlagModel('BAAI/bge-m3', 
                                       query_instruction_for_retrieval="Represent this sentence for searching relevant passages:",
                                       device=device_id if device_id else "cpu",
