...
def analyze_hada_by_genre():
    ...
    # '하다' 마커 추출
    hada_mask = df['marker_final'].str.endswith('하다', na=False)
    ...
    with open(RESULTS_DIR / 'hada_genre_analysis.json', 'w', encoding='utf-8') as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    
    print(f"\n결과 저장: {RESULTS_DIR / 'hada_genre_analysis.json'}")
