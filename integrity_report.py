...
실제 구현은 accuracy/p2s_evaluator.py에 있습니다.

Usage:
    python integrity_report.py --input <pa_output> --gold <gold_sentences>
    python accuracy/p2s_evaluator.py --input <pa_output> --gold <gold_sentences>
"""
...
# p2s_evaluator의 모든 함수와 클래스를 import하여 재export
from p2s_evaluator import *

# main 실행
if __name__ == "__main__":
    import p2s_evaluator
    sys.exit(p2s_evaluator.main())
