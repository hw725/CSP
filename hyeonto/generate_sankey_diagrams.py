...
def main():
    ...
    if 'sentence_k4' in data and 'phrase_k4' in data:
        ...
        sentence_book_cluster = data['sentence_k4'].groupby(['book', 'cluster_id']).size().reset_index(name='sentence_count')

        phrase_book_cluster = data['phrase_k4'].groupby(['book', 'cluster_id']).size().reset_index(name='phrase_count')

        

        sentence_totals = data['sentence_k4'].groupby('book').size().reset_index(name='sentence_total')

        phrase_totals = data['phrase_k4'].groupby('book').size().reset_index(name='phrase_total')
        ...
        common_books = set(sentence_book_cluster['book'].unique()) & set(phrase_book_cluster['book'].unique())
