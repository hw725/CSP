# 클러스터 라벨 변화 분석: 1:1 vs 3:1 (PHRASE)
...
- **Adjusted Rand Index (ARI)**: 0.3103
  - 범위: [-1, 1], 1에 가까울수록 클러스터 구조 일치
  - 0.8 이상: 매우 유사, 0.5~0.8: 중간, 0.5 미만: 상당한 차이

- **Normalized Mutual Information (NMI)**: 0.3153
...
|:---:|---:|---:|---:|
| Cluster 0 | 171132 | 35362 | 4515 |
| Cluster 1 | 43203 | 47455 | 81896 |
| Cluster 2 | 2319 | 162455 | 95020 |
...
- ARI 0.3103는 
  → **상당한 구조 변화**. 가중치가 클러스터 경계를 크게 재편함.

- 완전 일치율 48.7%는 
  → 다수의 샘플이 **클러스터 변경**. 가중치가 분류 체계 재구성.
