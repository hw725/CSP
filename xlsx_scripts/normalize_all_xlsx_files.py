...
def normalize_all_xlsx_files(root_dir: str = "xlsx", backup: bool = True):
    ...
    xlsx_files = sorted([f for f in root_path.rglob("*.xlsx") if not str(f).endswith(".bak")])
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="xlsx 폴더 전체 정규화 (기존 파일 .bak 백업)")
    parser.add_argument("--root-dir", type=str, default="xlsx", help="xlsx 폴더 경로 (기본: xlsx)")
