...
class P2SBoundaryDataset(Dataset):
    ...
    def __init__(
        self, samples: List[Dict], src_vocab: Dict, tgt_vocab: Dict, max_len: int = 512
    ):
...
def main():
    ...
    parser.add_argument(
        "--out", type=str, default="models/boundary_multitask.pt", help="출력 모델 경로"
    )
